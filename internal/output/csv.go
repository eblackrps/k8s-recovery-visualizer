...
func writeDRScoreCSV(dir string, b *model.Bundle) error {
	...
	_ = w.Write([]string{"Storage", fmt.Sprintf("%d", b.Score.Storage.Final), "100", domainWeightLabel("storage")})
	_ = w.Write([]string{"Workload", fmt.Sprintf("%d", b.Score.Workload.Final), "100", domainWeightLabel("workload")})
	_ = w.Write([]string{"Config", fmt.Sprintf("%d", b.Score.Config.Final), "100", domainWeightLabel("config")})
	_ = w.Write([]string{"Backup/Recovery", fmt.Sprintf("%d", b.Score.Backup.Final), "100", domainWeightLabel("backup")})
